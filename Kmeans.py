# -*- coding: utf-8 -*-
"""
Created on Sun Dec 29 16:59:35 2019
...
#input number of cluster, centers, cluster std
#return X = The generated samples.
#return y = The integer labels for cluster membership of each sample.
...
#setting k-means
#initial -> initialization method of the centroids. 
#value ->  Selects initial cluster centers for k-mean clustering in a smart way to speed up convergence.
#n_clusters -> number of centers
